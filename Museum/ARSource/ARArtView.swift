...
//        refreshButton.layer.borderColor = UIColor.white.cgColor
        ...
        sceneView.addSubview(refreshButton)
		//Surya
...
//        configuration.detectionImages = detectionImages
    ...
    @objc private func refreshButtonTapped(){
        delegate?.artWorkRefreshButtonTapped()
    }
	...
	private func setupArtwork() {
		...
		DispatchQueue.main.async {
            ...
            // Maikng the phantom image as optional - Edited by Surya
            
            if let artWorkImage = sceneArtwork.artwork.image{
                phantomArtworkPlane.firstMaterial?.diffuse.contents = artWorkImage
